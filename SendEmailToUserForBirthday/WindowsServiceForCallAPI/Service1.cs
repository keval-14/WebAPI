...
using System.Timers;
namespace WindowsServiceForCallAPI
{
    ...
    public partial class Service1 : ServiceBase
    {
        ...
        public void callAPI()
        {
            try
            {
                ...
                string URLForAPICallLocal = ConfigurationManager.AppSettings["URLForAPICallLocal"];
                ...
                string ApiData = new WebClient().DownloadString(URLForAPICallLocal);
